...
| **Fundo a fundo — saúde e assistência** | **SAÚDE COLETADA** (24/09/2026: painel "Pagamento de Resoluções" da SES, `ses_mg_resolucoes.py`, tela ESTADUAIS › Cofinanciamento Saúde); **assistência (Piso Mineiro) COLETADA** (26/09/2026: despesa aberta do dados.mg, UE 1480004 SEDESE/FEAS, `feas_estadual.py`, tela ASSISTÊNCIA SOCIAL › Estado (FEAS)); SES Resolve segue AUSENTE — o que segue abaixo é o registro de 25/08 | Emendas e cofinanciamento executados como **resolução, não convênio**. Painel público "Pagamento de Resoluções" da SES (2019-2026); Plano de Serviços do Piso Mineiro preenchido no próprio SIGCON (credencial que já temos). Novidade 2025: **SES Resolve** substituiu o SIGRES (login gov.br — candidato à captura de sessão que já dominamos) |
...
(~R$ 228 mi/ano, 10 parcelas); ⑤ ~~FEAS/Piso Gaúcho~~ **coletado em 26/09/2026** pela
despesa aberta do RS (UO 2178, `feas_estadual.py`); ⑥ Conexões RS, Drenagem RS, A Casa é
...
| **Fundo a fundo (SESA, FEAS/SETADES ~R$ 90 mi/ano, PETE/SEDU)** | AUSENTE | Rastros em portarias no DIO-ES, **que já coletamos** — regras de detecção por palavra-chave dão cobertura imediata de baixo custo. ⭐ 26/09/2026: MG e RS saíram pela DESPESA ABERTA do Estado (pagamento com o CNPJ do fundo — `feas_estadual.py`); quando houver cliente no ES, medir o mesmo caminho no CKAN capixaba antes do DIO |
