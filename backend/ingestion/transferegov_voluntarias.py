...
# pelo orcamento (parcial) em vez de ter terminado. `_scrape_municipio` devolve
# uma lista (mudar a assinatura quebraria run/run_one/run_proximos), entao o
# recado vai por aqui — mesmo padrao de _HIST_ORC. Quem le e run_proximos, p/
# carimbar o municipio como parcial em vez de "coletado".
