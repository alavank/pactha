import type { VoluntariasFases } from "@/lib/bi-format";
...
export interface MunicipioSummary {
  ...
  total_voluntarias: number;       // voluntárias CELEBRADAS (19/09/2026)
  valor_total_estadual: number;
  valor_total_federal: number;     // soma valor_global/repasse das CELEBRADAS
  voluntarias_fases?: VoluntariasFases; // análise e rejeitadas, AO LADO do número
