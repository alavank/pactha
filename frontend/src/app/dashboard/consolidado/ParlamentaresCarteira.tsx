...
/* CONSOLIDADO › PARLAMENTARES — quem destinou recurso à carteira (PR 1, 18/09/2026).
 *
 * Pedido da assessoria Freitas: "onde o Reginaldo Lopes mandou $$ para nossos
 * clientes?". O ranking é o da tela Parlamentares, com o escopo de todos os
 * municípios do usuário; o clique abre a ficha com o valor POR MUNICÍPIO.
 */
...
export function ParlamentaresCarteira() {
